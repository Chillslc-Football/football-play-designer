...
export const DRIVE_START_OPTIONS: DriveStartOption[] = [
  { id: 'own-1', label: 'Own 1', losYard: 1 },
  { id: 'own-5', label: 'Own 5', losYard: 5 },
  { id: 'own-10', label: 'Own 10', losYard: 10 },
  { id: 'own-20', label: 'Own 20', losYard: 20 },
  { id: 'own-25', label: 'Own 25', losYard: 25 },
  { id: 'own-30', label: 'Own 30', losYard: 30 },
  { id: 'own-35', label: 'Own 35', losYard: 35 },
  { id: 'own-40', label: 'Own 40', losYard: 40 },
  { id: 'own-45', label: 'Own 45', losYard: 45 },
  { id: '50', label: '50', losYard: 50 },
  { id: 'opp-45', label: 'Opp 45', losYard: 55 },
  { id: 'opp-40', label: 'Opp 40', losYard: 60 },
  { id: 'opp-35', label: 'Opp 35', losYard: 65 },
  { id: 'opp-30', label: 'Opp 30', losYard: 70 },
  { id: 'opp-25', label: 'Opp 25', losYard: 75 },
  { id: 'opp-20', label: 'Opp 20', losYard: 80 },
  { id: 'opp-15', label: 'Opp 15', losYard: 85 },
  { id: 'opp-10', label: 'Opp 10', losYard: 90 },
  { id: 'opp-5', label: 'Opp 5', losYard: 95 },
